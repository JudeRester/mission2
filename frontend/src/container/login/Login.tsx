...
export function loginRequestAction(data: String) {
    return ({
...
export function loginReducer(state = {}, action: any) {
    switch (action.type) {
...
function Login() {
    ...
    interface HeadContent {
        'Content-type': string;
        'Access-Control-Allow_Origin': string;
    }
    function handleLoginButton(e: any) {
        e.preventDefault();
